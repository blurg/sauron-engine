...
def test_can_add_condition_to_engine():
    ...
    assert engine.conditions["is_equal"](1, 1)
    assert not engine.conditions["is_equal"](1, 2)
...
def test_can_add_action_to_engine():
    ...
    assert hasattr(engine.actions["is_equal"], "__call__")
    assert engine.actions["is_equal"](1, 1)
    assert not engine.actions["is_equal"](1, 2)
